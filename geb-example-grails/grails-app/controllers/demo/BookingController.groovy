...
class BookingController implements BeanMessage {
    ...
    private GClass gClass = new GClass()
    private JClass jClass = new JClass()
    ...
    def index(Integer max) {
        jClass.javaMethod()
        jClass.javaInvokeGroovyMethod(gClass)
        gClass.simpleGroovyMethod()
        gClass.groovyInvokeJavaMethod(jClass)
        gClass.groovyInvokeJavaMethod1(jClass)
        gClass.simpleGroovyMethod2()
        gClass.println1()
        gClass.printVoid()
        gClass.getUser()
        GClass.returnNum()
    ...
    private void anotherNewMethod() {
        print "Second new method"
    }
}
